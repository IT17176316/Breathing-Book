...
public class age11L3_Q5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age11_l3_q5);
    ...
    private void result() {
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton3.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age11L3_Q5.this);
                LayoutInflater inflater = age11L3_Q5.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(age11L3_Q5.this, age11L3_Q6.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age11L3_Q5.this);
