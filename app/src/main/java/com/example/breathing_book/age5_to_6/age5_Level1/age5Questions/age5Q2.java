...
import com.example.breathing_book.age5_to_6.age5_Level1.age5Level3Questions.age5L3_Q3;

public class age5Q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_q2);

        radioButton =(RadioButton)findViewById(R.id.age5Q1radioOrange);
    ...
    private void result() {
        ...
        if (radioButton.isChecked()){
            AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5Q2.this);
            LayoutInflater inflater = age5Q2.this.getLayoutInflater();
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(age5Q2.this, age5Q3.class);
