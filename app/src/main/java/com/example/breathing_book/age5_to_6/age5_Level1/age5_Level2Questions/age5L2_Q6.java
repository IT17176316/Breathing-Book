...
public class age5L2_Q6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_l2_q6);
    ...
    private void wrongAnswer() {
        ...
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5L2_Q6.this);
        LayoutInflater inflater = age5L2_Q6.this.getLayoutInflater();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(age5L2_Q6.this, age5L2_Q7.class);
