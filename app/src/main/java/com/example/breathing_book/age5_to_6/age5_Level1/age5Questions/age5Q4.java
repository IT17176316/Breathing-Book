...
public class age5Q4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_q4);

        radioButton =(RadioButton)findViewById(R.id.age5Q1radioGreen);
    ...
    private void result(){
        if (radioButton.isChecked()){
            AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5Q4.this);
            LayoutInflater inflater = age5Q4.this.getLayoutInflater();
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(age5Q4.this, age5Q5.class);
