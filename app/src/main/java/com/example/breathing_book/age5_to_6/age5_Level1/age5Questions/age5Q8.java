...
public class age5Q8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_q8);

        radioButton =(RadioButton)findViewById(R.id.age5Q1radioBlue);
    ...
    private void result(){
        if (radioButton.isChecked()){
            AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5Q8.this);
            LayoutInflater inflater = age5Q8.this.getLayoutInflater();
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(age5Q8.this, age5Q9.class);
