...
public class age5L3_result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_l3_result);
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(age5L3_result.this, age5_Level3.class);
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(age5L3_result.this, SelectAge.class);
                startActivity(mainIntent);
                age5L3_result.this.finish();
            }
        });
