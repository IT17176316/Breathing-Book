...
public class age5Q3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_q3);

        radioButton =(RadioButton)findViewById(R.id.age5Q1radioYellow);
    ...
    private void result(){
        if (radioButton.isChecked()){
            AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5Q3.this);
            LayoutInflater inflater = age5Q3.this.getLayoutInflater();
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(age5Q3.this, age5Q4.class);
