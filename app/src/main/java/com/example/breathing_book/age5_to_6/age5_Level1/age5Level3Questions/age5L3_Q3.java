...
public class age5L3_Q3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_l3_q3);
    ...
    private void result(){
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton1.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5L3_Q3.this);
                LayoutInflater inflater = age5L3_Q3.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(age5L3_Q3.this, age5L3_Q4.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age5L3_Q3.this);
