package com.example.breathing_book.age5_to_6.age5_Level1.age5Level3Questions;
...
import com.example.breathing_book.age5_to_6.age5_Level1.age5_Level2Questions.age5L2_Q3;
import com.example.breathing_book.age5_to_6.age5_Level1.age5_Level2Questions.age5L_Q2;

public class age5L3_Q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_l3_q2);
    ...
    private void result() {
        ...
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton4.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5L3_Q2.this);
                LayoutInflater inflater = age5L3_Q2.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(age5L3_Q2.this, age5L3_Q3.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age5L3_Q2.this);
