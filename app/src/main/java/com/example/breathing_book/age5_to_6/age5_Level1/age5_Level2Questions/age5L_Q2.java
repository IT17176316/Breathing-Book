...
public class age5L_Q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_lq2);
    ...
    private void wrongAnswer() {
        ...
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5L_Q2.this);
        LayoutInflater inflater = age5L_Q2.this.getLayoutInflater();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(age5L_Q2.this, age5L2_Q3.class);
