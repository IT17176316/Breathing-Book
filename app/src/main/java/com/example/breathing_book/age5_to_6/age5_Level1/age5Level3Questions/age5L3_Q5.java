...
public class age5L3_Q5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_l3_q5);
    ...
    private void result(){
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton4.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5L3_Q5.this);
                LayoutInflater inflater = age5L3_Q5.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(age5L3_Q5.this, age5L3_Q6.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age5L3_Q5.this);
