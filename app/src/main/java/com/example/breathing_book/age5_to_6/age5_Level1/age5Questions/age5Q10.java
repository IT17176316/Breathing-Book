...
public class age5Q10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age5_q10);

        radioButton =(RadioButton)findViewById(R.id.age5Q1radioLbrown);
    ...
    private void result(){
        if (radioButton.isChecked()){
            AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age5Q10.this);
            LayoutInflater inflater = age5Q10.this.getLayoutInflater();
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(age5Q10.this, age5_results.class);
