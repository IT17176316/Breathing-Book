...
public class age10L3_Q9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age10_l3_q9);
    ...
    private void result() {
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton4.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age10L3_Q9.this);
                LayoutInflater inflater = age10L3_Q9.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(age10L3_Q9.this, age10L3_Q10.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age10L3_Q9.this);
