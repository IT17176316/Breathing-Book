...
public class age10L1_Q9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age10_l1_q9);
    ...
    private void result() {
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton1.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age10L1_Q9.this);
                LayoutInflater inflater = age10L1_Q9.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(age10L1_Q9.this, age10L1_Q10.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age10L1_Q9.this);
