...
public class age10L1_Q8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age10_l1_q8);
    ...
    private void result() {
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton2.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age10L1_Q8.this);
                LayoutInflater inflater = age10L1_Q8.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(age10L1_Q8.this, age10L1_Q9.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age10L1_Q8.this);
