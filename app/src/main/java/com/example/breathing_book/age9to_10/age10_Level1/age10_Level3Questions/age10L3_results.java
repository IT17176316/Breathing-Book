...
import com.example.breathing_book.age9to_10.age10_Level1.age10_Level2Questions.age10L2_results;
...
public class age10L3_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age10_l3_results);
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(age10L3_results.this, age10_Level3.class);
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(age10L3_results.this, SelectAge.class);
                startActivity(mainIntent);
                age10L3_results.this.finish();
            }
        });
