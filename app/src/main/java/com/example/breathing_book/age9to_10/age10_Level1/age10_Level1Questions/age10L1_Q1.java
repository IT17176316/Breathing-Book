package com.example.breathing_book.age9to_10.age10_Level1.age10_Level1Questions;
...
import com.example.breathing_book.age7_to_8.age7_Level1.age7_Level3Questions.age7L3_Q1;
import com.example.breathing_book.age7_to_8.age7_Level1.age7_Level3Questions.age7L3_Q2;

public class age10L1_Q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age10_l1_q1);
    ...
    private void result() {
        ...
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton1.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age10L1_Q1.this);
                LayoutInflater inflater = age10L1_Q1.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(age10L1_Q1.this, age10L1_Q2.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age10L1_Q1.this);
