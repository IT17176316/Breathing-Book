...
import com.example.breathing_book.age7_to_8.age7_Level1.age7_Level3Questions.age7L3_results;
...
public class age10L1_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age10_l1_results);
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(age10L1_results.this, age10_Level1.class);
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(age10L1_results.this, SelectAge.class);
                startActivity(mainIntent);
                age10L1_results.this.finish();
            }
        });
