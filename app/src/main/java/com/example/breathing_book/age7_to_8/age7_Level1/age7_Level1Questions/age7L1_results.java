...
import com.example.breathing_book.age5_to_6.age5_Level1.age5Level3Questions.age5L3_result;
...
public class age7L1_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age7_l1_results);
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(age7L1_results.this, age7_Level1.class);
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(age7L1_results.this, SelectAge.class);
                startActivity(mainIntent);
                age7L1_results.this.finish();
            }
        });
