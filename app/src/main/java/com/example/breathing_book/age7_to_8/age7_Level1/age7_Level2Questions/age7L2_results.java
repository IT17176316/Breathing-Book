...
import com.example.breathing_book.age7_to_8.age7_Level1.age7_Level1Questions.age7L1_results;
...
public class age7L2_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age7_l2_results);
        ...
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(age7L2_results.this, age7_Level2.class);
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(age7L2_results.this, SelectAge.class);
                startActivity(mainIntent);
                age7L2_results.this.finish();
            }
        });
