...
public class age7L3_Q7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age7_l3_q7);
    ...
    private void result() {
        if (radioButton1.isChecked() || radioButton2.isChecked() || radioButton3.isChecked() || radioButton4.isChecked()){
            ...
            if (radioButton2.isChecked()){
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(age7L3_Q7.this);
                LayoutInflater inflater = age7L3_Q7.this.getLayoutInflater();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(age7L3_Q7.this, age7L3_Q8.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(age7L3_Q7.this);
